...
const content: Record<Locale, Content> = {
  ...
  mr: {
    ...
    whyEngineer: {
      eyebrow: "अभियंताकडून बांधकाम का करावे",
      ...
      bullets: [
        ...
        "दुर्घटनामुळे होणारे अतिरिक्त खर्च टळतो.",
        "चांगल्या दर्जाच्या कामाची हमी मिळते.",
        "योग्य प्रमाणात योग्य साहित्य वापरल्यामुळे संरचनाची मजबुती मिळते.",
    ...
    team: {
      ...
      body:
        "हेमंत तांबे आणि माझे सहकारी मिळून विविध क्षेत्रात तांत्रिक मदत आणि मार्गदर्शन देऊ शकतो.",
      bullets: [
    ...
    permits: {
      ...
      bullets: [
        ...
        "सरकारी बाजू कागदपत्र संबंधी अडचणी येत नाहीत.",
        "भविष्यात सरकारी कर किंवा पेनल्टी टळतात.",
        "खरेदी-विक्रीचे प्रक्रिया सोपे होते.",
    ...
    network: {
      ...
      lookingFor: [
        ...
        "ज्यांचे सिव्हिल वर्क्स किंवा बांधकाम कार्य होते",
      ],
    },
    projects: {
